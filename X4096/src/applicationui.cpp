...
void ApplicationUI::initAudio()
{
    ...
    qDebug() << (pga->preload("assets/4096/sounds/", "low.wav", 1)).c_str();
    qDebug() << (pga->preload("assets/4096/sounds/", "high.wav", 1)).c_str();
    qDebug() << (pga->preload("assets/4096/sounds/", "win.wav", 1)).c_str();
...
// Initiate, load and install the application translation files.
    ...
    QString file_name = QString("X4096_%1").arg(locale_string);
