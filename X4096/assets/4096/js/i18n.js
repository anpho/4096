...
var qstr = {
    ...
    "zh_CN": {
        ...
        'sound': "音效设置",
        'usesound': '启用音效',
        'author': '移植自 https://github.com/gabrielecirulli/4096 ,由 Gabriele Cirulli 创建。基于 Veewo Studio 的1024和Asher Vollmer的Threes。',
        'mute': '静音',
        '_mute': '启用',
        '_reset': "重新开始",
        'status': '撤销功能状态:',
    ...
    "zh_TW": {
        "intro": '合併方塊，直到出現<strong>4096</strong>！',
        'keepgoing': '繼續玩',
        'tryagain': '重新開始',
        'share': '分享得分',
        ...
        'sound': "聲音設置",
        'usesound': '啓用聲音效果',
        'author': '移植自 https://github.com/gabrielecirulli/4096 ,由 Gabriele Cirulli 創建。基於 Veewo Studio 的1024和Asher Vollmer的Threes。',
        'mute': '靜音',
        '_mute': '啓用',
        '_reset': "重新開始",
        'status': '撤銷功能狀態:',
    ...
    'en_US': {
        ...
        'author': 'Ported from https://github.com/gabrielecirulli/4096 ,Created by Gabriele Cirulli. Based on 1024 by Veewo Studio and conceptually similar to Threes by Asher Vollmer.',
        'mute': 'OFF',
        '_mute': 'ON',
        '_reset': 'Reset Game',
    ...
    'fr_FR': {
        "intro": 'Regroupez les nombres jusqu\'à avoir 4096!',
        'keepgoing': 'Continuer',
        'tryagain': 'Réessayer',
        'share': 'Partager',
        ...
        'author': 'Jeu porté de ‎https://github.com/gabrielecirulli/4096, créé par Gabriele Cirulli, basé ‎sur 1024 Veewo Studio et similaire au concept Threes ‎d\'Asher Vollmer.',
        'mute': 'OFF',
        '_mute': 'ON',
        '_reset': 'Recommencer',
    ...
    'id_ID': {
        "intro": '<span style="font-size:0.9em">Gabungkan para angka & jadikan bernilai 4096!</span>',
        'keepgoing': 'Lanjutkan',
        'tryagain': 'Coba lagi',
        'share': 'Bagikan',
        ...
        'author': 'Portingan dari https://github.com/gabrielecirulli/4096, Dibuat oleh Gabriele Cirulli. Berdasarkan 1024 oleh Veewo Studio dan secara konsep mirip dengan Threes oleh Asher Vollmer.',
        'mute': 'Mati',
        '_mute': 'Hidup',
    ...
    "es_ES": {
        "intro": "Une los números y llega a la <strong>ficha 4096</strong>!",
        "keepgoing": "Continuar",
        ...
        "author": "Portado desde https://github.com/gabrielecirulli/4096, Creado por Gabriele Cirulli. Basado en 1024 de Veewo Studio y conceptualmente similar a Threes de Asher Vollmer.",
        "mute": "OFF",
        "_mute": "ON",
    ...
    "it_IT": {
        "intro": 'Unisci le tessere e raggiungi <strong>4096!</strong>',
        'keepgoing': 'Prosegui',
        'tryagain': 'Ricomincia',
        'share': 'Condividi',
        ...
        'author': 'Adattato da https://github.com/gabrielecirulli/4096 , Creato da Gabriele Cirulli. Basato su 1024 di Veewo Studio e concettualmente simile a Threes di Asher Vollmer.',
        'mute': 'OFF',
        '_mute': 'ON',
        '_reset': 'Reset',
    ...
    'de_DE': {
        "intro": 'Verbinde die Kacheln und bekomme die<strong> 4096 Kachel!</strong>',
